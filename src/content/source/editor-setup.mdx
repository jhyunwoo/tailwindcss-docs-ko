...
<img
  src={require("@/docs/img/cursor-intellisense.png").default.src}
...
<img
  src={require("@/docs/img/zed-intellisense.png").default.src}
...
<img
  src={require("@/docs/img/intellisense.png").default.src}
...
<img src={require("@/docs/img/prettier-banner.jpg").default.src} alt="" width={2400} height={819} className="rounded-lg" />
